...
typedef enum {
    ...
    /* 0x42 */ CAM_SET_MASK_TRANSFORMATION0,
    /* 0x43 */ CAM_SET_MASK_TRANSFORMATION1,
    /* 0x44 */ CAM_SET_MAX
} CameraSettingType;
...
typedef enum {
    ...
    /* 0x45 */ CAM_FUNC_SPEC8,
    /* 0x46 */ CAM_FUNC_SPEC9,
    /* 0x47 */ CAM_FUNC_TRANSFORM0,
    /* 0x48 */ CAM_FUNC_TRANSFORM1,
    /* 0x49 */ CAM_FUNC_MAX
} CameraFuncType;
...
} Transform0ReadOnlyData; // size = 0x4
...
typedef struct {
    ...
    /* 0x20 */ s16 unk_20;
    /* 0x22 */ s16 timer;
} Transform0ReadWriteData; // size = 0x24

typedef struct {
    /* 0x00 */ Transform0ReadOnlyData roData;
    /* 0x04 */ Transform0ReadWriteData rwData;
} Transform0; // size = 0x28

typedef struct {
    /* 0x00 */ s16 interfaceFlags;
} Transform1ReadOnlyData; // size = 0x4
...
typedef struct {
    ...
    /* 0x24 */ s16 unk_24;
    /* 0x26 */ s16 timer;
} Transform1ReadWriteData; // size = 0x28

typedef struct {
    /* 0x00 */ Transform0ReadOnlyData roData;
    /* 0x04 */ Transform0ReadWriteData rwData;
} Transform1; // size = 0x2C
