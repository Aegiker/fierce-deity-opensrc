...
/* 0x01D7 */ DEFINE_ACTOR(En_Fall, ACTOR_EN_FALL, ACTOROVL_ALLOC_NORMAL, "En_Fall")
/* 0x0199 */ DEFINE_ACTOR(Oceff_Wipe7, ACTOR_OCEFF_WIPE7, ACTOROVL_ALLOC_ABSOLUTE, "Oceff_Wipe7")
