...
typedef enum {
    ...
    /* 12 */ OCARINA_SONG_HEALING,
    /* 13 */ OCARINA_SONG_SCARECROW_SPAWN,
    /* 14 */ OCARINA_SONG_MEMORY_GAME,
    /* 15 */ OCARINA_SONG_MAX,
    /* 16 */ OCARINA_SONG_SCARECROW_LONG = OCARINA_SONG_MAX // anything larger than 13 is considered the long scarecrow's song
} OcarinaSongId;
...
typedef enum {
    ...
    /* 0x0E */ OCARINA_ACTION_TEACH_HEALING,
    ...
    /* 0x1B */ OCARINA_ACTION_PLAYBACK_HEALING,
    ...
    /* eeee */ OCARINA_ACTION_CHECK_HEALING,
