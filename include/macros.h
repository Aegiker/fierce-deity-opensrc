...
#define ERA_IN_PAST (gSaveContext.era == ERA_PAST)
#define ERA_IN_FUTURE (gSaveContext.era == ERA_FUTURE)
...
#define CHECK_BTN_ALL(state, combo) Check_Button_All(state, combo)
#define CHECK_BTN_ANY(state, combo) Check_Button_Any(state, combo)
