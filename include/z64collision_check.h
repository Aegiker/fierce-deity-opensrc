...
#define DMG_SWORDBEAM (DMG_SLASH_MASTER | DMG_HAMMER | DMG_FIRE | DMG_ARROW_NORMAL | DMG_ARROW_LIGHT | DMG_EXPLOSIVE | DMG_SWORD_BEAM)

#define SWORD_BEAM_DMG_AMOUNT 8
