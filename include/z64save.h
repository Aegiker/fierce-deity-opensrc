...
typedef struct {
    ...
    /* 0x1B */ u8 mode4Param;
    /* 0x1C */ u8 altPrimColor[4]; // used with drawMode 1
    /* 0x20 */ u8 altEnvColor[4]; // used with drawMode 1
} SramBlureInit2; // size = 0x24
...
typedef struct {
    ...
    /*chaosmod*/ SramBlureInit2 blureEffectParams;
    /*chaosmod*/ u8 era;
    /*chaosmod*/ u8 bButtonMemory;
    /*chaosmod*/ u8 fierceDeityMemory;
    /*chaosmod*/ u8 deityAgeMemory;
    ...
    /*chaosmod*/ u8 finalHoursFlag;
    /*chaosmod*/ u16 finalHoursTimer;
    /*chaosmod*/ u8 moonSpawnFlag;
    /*chaosmod*/ s16 chaosEarthquakeIndex;
    /*chaosmod*/ u8 chaosIsForbidden;
    /*chaosmod*/ u16 chaosEffectTimer;
    /*chaosmod*/ u8 lostItemCollectionFlag;
    /*chaosmod*/ u8 junkItemCollectionFlag;
    /*chaosmod*/ u8 screenshotExists;
