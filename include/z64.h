...
#define FIZZINPOP_R 0x00
#define FIZZINPOP_G 0x80
#define FIZZINPOP_B 0xFF

#define CS_ALLOW_SKIP 0
#define DBG_ALLOW_MAPSELECT 0
#define DBG_ALLOW_NOCLIP 0
#define USABILITY_MAX 88

#define TRANSFORM_EXTRA_FADE_FRAMES 130
#define TRANSFORM_FADE_SPEED 45

#define ONEPOINTDEMO_TRANSFORM_MASK_HUMAN 1040
#define ONEPOINTDEMO_TRANSFORM_MASK_FORM 1041
#define ONEPOINTDEMO_SMOOTH_RETURN 1020
...
typedef struct {
    ...
    /* 0x00008 */ Gfx polyOpaBuffer[0x22E0]; // 0x17E0
    /* 0x0BF08 */ Gfx polyXluBuffer[0x1200]; // 0x800
...
typedef struct {
    ...
    /* 0x000C */ u8     playerIndex; // "object_link_child" or "object_link_boy" index in bank
    /* 0x000D */ ObjectStatus status[OBJECT_EXCHANGE_BANK_MAX];
...
typedef enum {
    TESTSTATE_NONE,
    TESTSTATE_TAKE_PICTURE,
    TESTSTATE_PICTURE_READY,
    TESTSTATE_SHOW_PICTURE
} ScreenshotState;
...
typedef struct PlayState {
    ...
    /* chaosmod*/ u8 chaosTimerInitFlag;
    /* chaosmod*/ ChaosEffect* activeEffects;
    /* chaosmod*/ u8 darkLinkAmbushFlag;
    /* chaosmod*/ PreRender chaosPreRender;
    /* chaosmod*/ u8 screenshotState;
    /* chaosmod*/ u16 screenshotTimer;
    /* chaosmod*/ s8 ageChangeFlag;
    /* chaosmod*/ u8 ageChangeTimer; // frames to avoid drawing Link
    /* chaosmod*/ s16 ageChangeFadeAlpha;
...
typedef struct {
    ...
    /*         */ u8 specialTimerDurationFS;
    /*         */ u8 starterSaveOption;
