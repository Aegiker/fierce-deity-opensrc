...
class SampleHeader:
    ...
    def serializeTo(self, output):
        ...
        length_8 = (self.length & 0xFF0000) >> 16
        length_16 = self.length & 0xFFFF
        output.write(struct.pack(">bbHIII", modes, length_8, length_16, self.offsetInBank, self.loopOffset, self.bookOffset))
        return 16
