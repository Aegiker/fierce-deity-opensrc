...
static u8 gItemAdultUsability[88] = {
    0, /* ITEM_DEKU_STICK */
    1, /* ITEM_DEKU_NUT */
    1, /* ITEM_BOMB */
    1, /* ITEM_BOW */
    ...
    1, /* ITEM_DINS_FIRE */
    0, /* ITEM_SLINGSHOT */
    1, /* ITEM_OCARINA_FAIRY*/
    1, /* ITEM_OCARINA_OF_TIME */
    1, /* ITEM_BOMBCHU */
    1, /* ITEM_HOOKSHOT */
    1, /* ITEM_LONGSHOT */
    1, /* ITEM_ARROW_ICE */
    1, /* ITEM_FARORES_WIND */
    0, /* ITEM_BOOMERANG */
    1, /* ITEM_LENS_OF_TRUTH */
    0, /* ITEM_MAGIC_BEAN */
    1, /* ITEM_HAMMER */
    1, /* ITEM_ARROW_LIGHT */
    1, /* ITEM_NAYRUS_LOVE */
    1, /* ITEM_BOTTLE_EMPTY */
    1, /* ITEM_BOTTLE_POTION_RED */
    1, /* ITEM_BOTTLE_POTION_GREEN */
    1, /* ITEM_BOTTLE_POTION_BLUE */
    1, /* ITEM_BOTTLE_FAIRY */
    1, /* ITEM_BOTTLE_FISH */
    1, /* ITEM_BOTTLE_MILK_FULL */
    1, /* ITEM_BOTTLE_RUTOS_LETTER */
    1, /* ITEM_BOTTLE_BLUE_FIRE */
    1, /* ITEM_BOTTLE_BUG */
    1, /* ITEM_BOTTLE_BIG_POE */
    1, /* ITEM_BOTTLE_MILK_HALF */
    1, /* ITEM_BOTTLE_POE */
    0, /* ITEM_WEIRD_EGG */
    0, /* ITEM_CHICKEN */
    0, /* ITEM_ZELDAS_LETTER */
    0, /* ITEM_MASK_KEATON */
    0, /* ITEM_MASK_SKULL */
    0, /* ITEM_MASK_SPOOKY */
    0, /* ITEM_MASK_BUNNY_HOOD */
    0, /* ITEM_MASK_GORON */
    0, /* ITEM_MASK_ZORA */
    0, /* ITEM_MASK_GERUDO */
    0, /* ITEM_MASK_TRUTH */
    ...
    0, /* ITEM_SWORD_KOKIRI */
    1, /* ITEM_SWORD_MASTER */
    1, /* ITEM_SWORD_BIGGORON */
    1, /* ITEM_SWORD_DEITY */
    1, /* ITEM_MASK_DEITY */
    0, /* ITEM_SHIELD_DEKU */
    1, /* ITEM_SHIELD_HYLIAN */
    ...
    1, /* ITEM_BOOTS_IRON */
    1, /* ITEM_BOOTS_HOVER */
    0, /* ITEM_BULLET_BAG_30 */
    0, /* ITEM_BULLET_BAG_40 */
    0, /* ITEM_BULLET_BAG_50 */
    1, /* ITEM_QUIVER_30 */
    1, /* ITEM_QUIVER_40 */
    1, /* ITEM_QUIVER_50 */
    1, /* ITEM_BOMB_BAG_20 */
    1, /* ITEM_BOMB_BAG_30 */
    1, /* ITEM_BOMB_BAG_40 */
    0, /* ITEM_STRENGTH_GORONS_BRACELET */
    1, /* ITEM_STRENGTH_SILVER_GAUNTLETS */
    1, /* ITEM_STRENGTH_GOLD_GAUNTLETS */
    1, /* ITEM_SCALE_SILVER */
    1, /* ITEM_SCALE_GOLDEN */
    1, /* ITEM_GIANTS_KNIFE */
};

static u8 gItemChildUsability[] = {
    1, /* ITEM_DEKU_STICK */
    1, /* ITEM_DEKU_NUT */
    1, /* ITEM_BOMB */
    0, /* ITEM_BOW */
    ...
    1, /* ITEM_WEIRD_EGG */
    1, /* ITEM_CHICKEN */
    1, /* ITEM_ZELDAS_LETTER */
    1, /* ITEM_MASK_KEATON */
    1, /* ITEM_MASK_SKULL */
    1, /* ITEM_MASK_SPOOKY */
    1, /* ITEM_MASK_BUNNY_HOOD */
    1, /* ITEM_MASK_GORON */
    1, /* ITEM_MASK_ZORA */
    1, /* ITEM_MASK_GERUDO */
    1, /* ITEM_MASK_TRUTH */
    ...
    0, /* ITEM_STRENGTH_SILVER_GAUNTLETS */
    0, /* ITEM_STRENGTH_GOLD_GAUNTLETS */
    1, /* ITEM_SCALE_SILVER */
    1, /* ITEM_SCALE_GOLDEN */
    0, /* ITEM_GIANTS_KNIFE */
};

static u8 gItemDeityUsability[] = {
    0, /* ITEM_DEKU_STICK */
    0, /* ITEM_DEKU_NUT */
    0, /* ITEM_BOMB */
    0, /* ITEM_BOW */
...
void Parameter_DebugString(GraphicsContext* gfxCtx, u8 line, const char* format, ...) {
    Gfx* gfx;
    Gfx* opaStart;
    GfxPrint printer;
    s32 pad;
    ...
    OPEN_DISPS(gfxCtx, "../z_zelda2.c", __LINE__);
    ...
    GfxPrint_SetPos(&printer, 1, line);

    va_start(va, format);
    vsprintf(buffer, format, va);
    va_end(va);

    GfxPrint_Printf(&printer, &buffer);
    ...
    CLOSE_DISPS(gfxCtx, "../z_zelda2.c", __LINE__);
...
u8 Parameter_CanUseItem(u32 item) {
    if (LINK_IS_ADULT) {
        return (gItemAdultUsability[item]);
    } else if (LINK_IS_CHILD) {
        return (gItemChildUsability[item]);
    } else if (LINK_IS_DEITY) {
        //if ((item == ITEM_TUNIC_KOKIRI || item == ITEM_BOOTS_KOKIRI) || (ERA_IN_FUTURE && (item == ITEM_TUNIC_GORON || item == ITEM_TUNIC_ZORA || item == ITEM_BOOTS_IRON || item == ITEM_BOOTS_HOVER))) return true;
        return (gItemDeityUsability[item]);
    }
}
...
void func_80083108(PlayState* play) {
    ...
    if ((gSaveContext.cutsceneIndex < 0xFFF0) ||
        ...
        if ((play->shootingGalleryStatus > 1) ||
            ...
            if ((Player_GetEnvironmentalHazard(play) >= PLAYER_ENV_HAZARD_UNDERWATER_FLOOR) &&
                ...
                // removed lots of horse stuff and put it in somewhere else land
                ...
                for (i = 1; i < 4; i++) {
                    ...
                    } else if (!Parameter_CanUseItem(gSaveContext.equips.buttonItems[i])) {
                        if (gSaveContext.buttonStatus[i] != BTN_DISABLED) {
                            gSaveContext.buttonStatus[i] = BTN_DISABLED;
                            sp28 = true;
                        }
                    } else { // scene restrictions
    ...
    if (sp28) {
        gSaveContext.hudVisibilityMode = HUD_VISIBILITY_NO_CHANGE;
        if ((play->transitionTrigger == TRANS_TRIGGER_OFF) && (play->transitionMode == TRANS_MODE_OFF) && (play->ageChangeFadeAlpha == 0)) {
            Interface_ChangeHudVisibilityMode(HUD_VISIBILITY_ALL);
...
void Inventory_SetAgeEquipment(u8 age) {
    s16 i;
...
s16 Inventory_FindSlotForItem(u8 item) {
    s16 i;
    for (i = 0; i < ARRAY_COUNT(gSaveContext.inventory.items); i++) {
        if (gSaveContext.inventory.items[i] == item) {
            return i;
        }
    }
...
u8 Inventory_GetFirstRecoveryItem(u8* slotOut) {
    s16 i;
    for (i = 0; i < ARRAY_COUNT(gSaveContext.recoveryItems); i++) {
        if (gSaveContext.recoveryItems[i] != ITEM_NONE && gSaveContext.recoveryItems[i] != ITEM_SOLD_OUT) { // there is an item
            s16 slot = Inventory_FindSlotForItem(gSaveContext.recoveryItems[i]);
            if (slot == -1) { // player doesn't have it anymore
                *slotOut = i;
                return gSaveContext.recoveryItems[i];
            }
        }
    }
    return ITEM_NONE;
...
u8 Item_Give(PlayState* play, u8 item) {
    ...
    s16 intendedSlot;
    s16 temp;
    u8 itemNonexistent = 0;

    // find an existing slot
    if (item >= ITEM_DEKU_STICKS_5) {
        slot = Inventory_FindSlotForItem(sExtraItemBases[item - ITEM_DEKU_STICKS_5]);
        intendedSlot = SLOT(sExtraItemBases[item - ITEM_DEKU_STICKS_5]);
    } else {
        slot = Inventory_FindSlotForItem(item);
        intendedSlot = SLOT(item);
    }

    if (slot == -1) { // it failed for one reason or another
        itemNonexistent = 1;
        slot = intendedSlot;
    }
    ...
    if ((item >= ITEM_MEDALLION_FOREST) && (item <= ITEM_MEDALLION_LIGHT)) {
        ...
        if (item == ITEM_SWORD_BIGGORON) {
            ...
            gSaveContext.fierceDeityMemory = ITEM_SWORD_MASTER;
            gSaveContext.equips.equipment &= (u16) ~(0xF << (EQUIP_TYPE_SWORD * 4));
            gSaveContext.equips.equipment |= EQUIP_VALUE_SWORD_MASTER << (EQUIP_TYPE_SWORD * 4);
            Interface_LoadItemIcon1(play, 0);
        }
        ...
        if (CUR_UPG_VALUE(UPG_BOMB_BAG) == 0) {
            ...
            INV_CONTENT(ITEM_BOMB) = ITEM_BOMB; // queggle
        ...
        if (itemNonexistent) {
            ...
            gSaveContext.recoveryItems[SLOT(ITEM_DEKU_STICK)] = ITEM_DEKU_STICK;
        }
        ...
        if (itemNonexistent) {
            ...
            gSaveContext.recoveryItems[SLOT(ITEM_DEKU_NUT)] = ITEM_DEKU_NUT;
        }
        ...
        gSaveContext.recoveryItems[SLOT(item)] = item;
        for (i = 1; i < 4; i++) {
            if (gSaveContext.equips.buttonItems[i] == ITEM_HOOKSHOT) {
                gSaveContext.equips.buttonItems[i] = ITEM_LONGSHOT;
        ...
        if (itemNonexistent || CUR_CAPACITY(UPG_DEKU_STICKS) == 0) {
        ...
        if (itemNonexistent || CUR_CAPACITY(UPG_DEKU_NUTS) == 0) {
        ...
        if (itemNonexistent) {
            ...
            gSaveContext.recoveryItems[SLOT(ITEM_BOMBCHU)] = ITEM_BOMBCHU;
        ...
        for (i = 0; i < 4; i++) {
            if (gSaveContext.inventory.items[temp + i] == ITEM_NONE) {
                ...
                gSaveContext.recoveryItems[temp + i] = item;
                return ITEM_NONE;
            }
        }
...
void Magic_DrawMeter(PlayState* play) {
    ...
    if (gSaveContext.magicLevel != 0) {
        ...
        if (gSaveContext.healthCapacity >= 0x150) { // todo: make this not look bad
            u8 rows = (u8)(gSaveContext.healthCapacity / 0xA0); // this logic is AWFUL, please check my old repository
            if ((gSaveContext.healthCapacity % 0xA0) != 0) {
                rows++;
            }
            magicMeterY = 22; // two rows of hearts
            magicMeterY += ((10) * rows);
        }
...
void Interface_DrawFinalHours(PlayState* play) {
    static s16 sFinalHoursClockDigitsRed = 0;
    static s16 sFinalHoursClockFrameEnvRed = 0;
    static s16 sFinalHoursClockFrameEnvGreen = 0;
    static s16 sFinalHoursClockFrameEnvBlue = 0;
    static s16 sFinalHoursClockColorTimer = 15;
    static s16 sFinalHoursClockColorTargetIndex = 0;
    ...
    if (!gSaveContext.finalHoursFlag) {
        return;
    }

    sp1E6 = interfaceCtx->bAlpha; // this is alpha

    timeUntilMoonCrash = 0x4000 - gSaveContext.finalHoursTimer;

    // flash red
    if (gSaveContext.finalHoursTimer >= 0x3555) {
        colorStep =
    ...
    for (sp1C6 = 0; sp1C6 < 8; sp1C6++) {
        ...
        OVERLAY_DISP =
            Gfx_TextureI8(OVERLAY_DISP, sFinalHoursDigitTextures[finalHoursClockSlots[sp1C6]],
                                8, 8, index, 205, 8, 8, 1 << 10, 1 << 10);
    }

    CLOSE_DISPS(play->state.gfxCtx, "../z_parameter.c", 3405);
...
void Interface_Draw(PlayState* play) {
    ...
    if (pauseCtx->debugState == 0) {
        ...
        Minimap_Draw(play); // minimap is scary
...
void Interface_Update(PlayState* play) {
    ...
    if (CUR_UPG_VALUE(UPG_BOMB_BAG) != 0) { // the bomb bag always fails the check because it isn't a bomb
        gSaveContext.recoveryItems[SLOT(ITEM_BOMB)] = ITEM_BOMB;
    }
    if (CUR_UPG_VALUE(UPG_QUIVER) != 0) {
        gSaveContext.recoveryItems[SLOT(ITEM_BOW)] = ITEM_BOW;
    }

    if (GET_EVENTCHKINF(EVENTCHKINF_33) != 0) { // stop giving back ruto's letter
        if (gSaveContext.recoveryItems[SLOT_BOTTLE_1] == ITEM_BOTTLE_RUTOS_LETTER) gSaveContext.recoveryItems[SLOT_BOTTLE_1] = ITEM_BOTTLE_EMPTY;
        if (gSaveContext.recoveryItems[SLOT_BOTTLE_2] == ITEM_BOTTLE_RUTOS_LETTER) gSaveContext.recoveryItems[SLOT_BOTTLE_2] = ITEM_BOTTLE_EMPTY;
        if (gSaveContext.recoveryItems[SLOT_BOTTLE_3] == ITEM_BOTTLE_RUTOS_LETTER) gSaveContext.recoveryItems[SLOT_BOTTLE_3] = ITEM_BOTTLE_EMPTY;
        if (gSaveContext.recoveryItems[SLOT_BOTTLE_4] == ITEM_BOTTLE_RUTOS_LETTER) gSaveContext.recoveryItems[SLOT_BOTTLE_4] = ITEM_BOTTLE_EMPTY;
    }
