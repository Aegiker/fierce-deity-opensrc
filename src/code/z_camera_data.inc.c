...
CameraMode sCamSetMaskTransformation0Modes[] = {
    CAM_SETTING_MODE_ENTRY(CAM_FUNC_TRANSFORM0, sSetCsCModeNormalData), // CAM_MODE_NORMAL
};

CameraMode sCamSetMaskTransformation1Modes[] = {
    CAM_SETTING_MODE_ENTRY(CAM_FUNC_TRANSFORM1, sSetCsCModeNormalData), // CAM_MODE_NORMAL
};
...
CameraSetting sCameraSettings[] = {
    ...
    { { 0x45000001 }, sCamSetMaskTransformation0Modes },  // CAM_SET_MASK_TRANSFORMATION0
    { { 0x45000001 }, sCamSetMaskTransformation1Modes },  // CAM_SET_MASK_TRANSFORMATION1
};
...
s32 (*sCameraFunctions[])(Camera*) = {
    ...
    Camera_Transform0, // CAM_FUNC_TRANSFORM0
    Camera_Transform1, // CAM_FUNC_TRANSFORM1
};
