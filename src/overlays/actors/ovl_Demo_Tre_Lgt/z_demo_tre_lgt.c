...
static DemoTreLgtInfo sDemoTreLgtInfo[NUM_FORMS] = {
...
static CurveAnimationHeader* sAnimations[NUM_FORMS] = { &gTreasureChestCurveAnim_4B60, &gTreasureChestCurveAnim_4F70, &gTreasureChestCurveAnim_4B60 };
