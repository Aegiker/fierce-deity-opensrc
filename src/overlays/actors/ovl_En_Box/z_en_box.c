...
static AnimationHeader* sLargeChestAnimations[NUM_FORMS] = { &gTreasureChestAnim_00024C, &gTreasureChestAnim_000128, &gTreasureChestAnim_00024C};

static AnimationHeader* sSmallChestAnimations[NUM_FORMS] = {&gTreasureChestAnim_00043C, &gTreasureChestAnim_00043C, &gTreasureChestAnim_00043C};
...
void EnBox_Init(Actor* thisx, PlayState* play2) {
    ...
    animFrameStart = 0.0f;
    anim = sLargeChestAnimations[((void)0, gSaveContext.linkAge)];
    colHeader = NULL;
...
void EnBox_WaitOpen(EnBox* this, PlayState* play) {
    ...
    if (this->unk_1F4 != 0) { // unk_1F4 is modified by player code
        ...
        if (this->unk_1F4 < 0) {
            anim = sSmallChestAnimations[linkAge];
        } else {
            anim = sLargeChestAnimations[linkAge];
        }
