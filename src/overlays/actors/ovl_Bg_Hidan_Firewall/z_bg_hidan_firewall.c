...
static void* sFireballTexs[] = {
    gFireTempleFireball0Tex2, gFireTempleFireball1Tex2, gFireTempleFireball2Tex2, gFireTempleFireball3Tex2,
    gFireTempleFireball4Tex2, gFireTempleFireball5Tex2, gFireTempleFireball6Tex2, gFireTempleFireball7Tex2,
};
...
void BgHidanFirewall_Draw(Actor* thisx, PlayState* play) {
    ...
    gSPDisplayList(POLY_XLU_DISP++, gFireTempleFireballUpperHalfDL2);
