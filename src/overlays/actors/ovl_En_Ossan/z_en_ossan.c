...
void EnOssan_Init(Actor* thisx, PlayState* play) {
    ...
    if (this->actor.params == OSSAN_TYPE_TALON && (ERA_IN_FUTURE)) {
    ...
    if (this->actor.params == OSSAN_TYPE_KAKARIKO_POTION && (ERA_IN_PAST)) {
        Actor_Kill(&this->actor);
        return;
    }
...
void EnOssan_UpdateCursorAnim(EnOssan* this) { // n64 colors
    f32 t;
    ...
    this->cursorColorG = ColChanMix(0x50, 80.0f, t);
    this->cursorColorB = ColChanMix(0xFF, 0.0f, t);
