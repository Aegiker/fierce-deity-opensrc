...
EnFr_Healing(EnFr* this, PlayState* play) {
...
EnFr_SetupHealing(EnFr* this, PlayState* play) {
    Player* player = GET_PLAYER(play);
    AudioOcarina_SetInstrument(OCARINA_INSTRUMENT_OFF);
    play->msgCtx.msgMode = MSGMODE_PAUSED;
    this->actor.textId = 0x023D;
    Message_StartTextbox(play, this->actor.textId, &this->actor);
    this->actionFunc = EnFr_Healing;
}
...
void EnFr_ListeningToOcarinaNotes(EnFr* this, PlayState* play) {
    ...
    switch (play->msgCtx.ocarinaMode) { // Ocarina Song played
        ...
        case OCARINA_MODE_0A:
            ...
            break;
        case OCARINA_MODE_0B:
            EnFr_SetupHealing(this, play);
            break;
