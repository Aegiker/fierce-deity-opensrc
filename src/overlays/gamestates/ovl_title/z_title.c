...
void ConsoleLogo_PrintBuildInfo(Gfx** gfxp) {
    ...
    GfxPrint_Printf(printer, "Fierce Deity Mask in OoT");

    GfxPrint_SetColor(printer, 255, 155, 255, 255);
    GfxPrint_SetPos(printer, 34, 1);
    GfxPrint_Printf(printer, "v.");
    GfxPrint_Printf(printer, gChaosVersion);

    if (ExpansionPak_Found()) {
        GfxPrint_SetColor(printer, 255, 255, 255, 255);
        GfxPrint_SetPos(printer, 10, 22);
        GfxPrint_Printf(printer, "youtube.com/@Aegiker");
        GfxPrint_SetColor(printer, 255, 255, 255, 255);
        ...
        GfxPrint_SetPos(printer, 12, 26);
        GfxPrint_Printf(printer, "Merry Christmas!!");
    ...
    timerer++;
        ...
        if ((timerer / 24) % 2) {
            ...
            GfxPrint_SetColor(printer, 140, 0, 0, 255);
        }
        
        GfxPrint_SetPos(printer, 11, 24);
