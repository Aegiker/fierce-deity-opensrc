...
Vtx object_link_childVtx_007BE8[] = {
#include "assets/objects/object_link_child/object_link_childVtx_007BE8.vtx.inc"
};
...
Gfx gLinkChildFierceDeitySwordDL[] = {
    gsSPTexture(0x03E8, 0x01F4, 0, G_TX_RENDERTILE, G_ON),
    gsDPPipeSync(),
    gsDPSetCombineLERP(TEXEL0, 0, SHADE, PRIMITIVE, TEXEL0, 0, PRIMITIVE, 0, PRIMITIVE, 0, SHADE, 0, 0, 0, 0,
                       PRIMITIVE),
    gsDPSetPrimColor(0, 0xFF, 0xF8, 0xEF, 0xB6, 255),
    //gsDPSetPrimColor(0, 0xFF, 128, 128, 128, 255),
    //gsDPSetEnvColor(0, 20, 80, 255),
    gsDPSetRenderMode(G_RM_FOG_SHADE_A, G_RM_AA_ZB_OPA_SURF2),
    gsDPSetTextureLUT(G_TT_NONE),
    gsDPLoadTextureBlock(gLinkChildDeitySwordTex, G_IM_FMT_I, G_IM_SIZ_8b, 16, 16, 0, G_TX_MIRROR | G_TX_WRAP,
    ...
    gsSPLoadGeometryMode(G_ZBUFFER | G_SHADE | G_FOG | G_LIGHTING | G_TEXTURE_GEN | G_TEXTURE_GEN_LINEAR |
                         G_SHADING_SMOOTH),
    gsSPVertex(&object_link_childVtx_007BE8[20], 32, 0),
    ...
    gsDPPipeSync(),
    gsDPSetPrimColor(0, 0xFF, 0x79, 0xCF, 0x9F, 255),
    //gsDPSetEnvColor(138, 20, 90, 255),
    gsDPLoadTextureBlock(gLinkChildDeitySwordTex, G_IM_FMT_I, G_IM_SIZ_8b, 16, 16, 0, G_TX_MIRROR | G_TX_WRAP,
                         G_TX_MIRROR | G_TX_WRAP, 4, 4, G_TX_NOLOD, G_TX_NOLOD),
    gsSPLoadGeometryMode(G_ZBUFFER | G_SHADE | G_FOG | G_LIGHTING | G_TEXTURE_GEN | G_TEXTURE_GEN_LINEAR |
                         G_SHADING_SMOOTH),
    gsSPVertex(object_link_childVtx_007BE8, 20, 0),
...
Gfx gLinkChildFierceDeityLeftHandHoldingSwordDL[] = {
    gsSPDisplayList(gLinkChildLeftFistNearDL),
    gsSPBranchList(gLinkChildFierceDeitySwordDL),
};
...
u64 gLinkChildDeitySwordTex[] = {
#include "assets/objects/object_link_child/tex_000B00.i8.inc.c"
};
