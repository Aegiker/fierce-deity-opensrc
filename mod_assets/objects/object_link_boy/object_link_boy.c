...
u64 gLinkAdultDeitySwordTex[] = {
#include "assets/objects/object_link_boy/tex_000B00.i8.inc.c"
};
...
Vtx object_link_boyVtx_007BE8[] = {
#include "assets/objects/object_link_boy/object_link_boyVtx_007BE8.vtx.inc"
};
...
Gfx gLinkAdultFierceDeitySwordDL[] = {
    ...
    gsDPSetRenderMode(G_RM_FOG_SHADE_A, G_RM_AA_ZB_OPA_SURF2),
    gsDPSetTextureLUT(G_TT_NONE),
    gsDPLoadTextureBlock(gLinkAdultDeitySwordTex, G_IM_FMT_I, G_IM_SIZ_8b, 16, 16, 0, G_TX_MIRROR | G_TX_WRAP,
    ...
    gsSPLoadGeometryMode(G_ZBUFFER | G_SHADE | G_FOG | G_LIGHTING | G_TEXTURE_GEN | G_TEXTURE_GEN_LINEAR |
                         G_SHADING_SMOOTH),
    gsSPVertex(&object_link_boyVtx_007BE8[20], 32, 0),
    ...
    gsSPLoadGeometryMode(G_ZBUFFER | G_SHADE | G_FOG | G_LIGHTING | G_TEXTURE_GEN | G_TEXTURE_GEN_LINEAR |
                         G_SHADING_SMOOTH),
    gsSPVertex(object_link_boyVtx_007BE8, 20, 0),
    gsSP2Triangles(0, 1, 2, 0, 0, 3, 1, 0),
...
Gfx gLinkAdultFierceDeityLeftHandHoldingSwordDL[] = {
    gsSPDisplayList(gLinkAdultLeftHandClosedNearDL),
    gsSPBranchList(gLinkAdultFierceDeitySwordDL),
};
