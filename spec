...
beginseg
    name "Audiobank"
    include "build/assets/soundfonts/00_Sound_Effects_1.o"
    include "build/assets/soundfonts/01_Sound_Effects_2.o"
    include "build/assets/soundfonts/02_Ambient_Sounds.o"
    include "build/assets/soundfonts/03_Orchestra.o"
    include "build/assets/soundfonts/04_Deku_Tree.o"
    include "build/assets/soundfonts/05_Market.o"
    include "build/assets/soundfonts/06_Title_Theme.o"
    include "build/assets/soundfonts/07_Jabu_Jabu.o"
    include "build/assets/soundfonts/08_Child_Kakariko_Village.o"
    include "build/assets/soundfonts/09_Fairy_Fountain.o"
    ...
    include "build/assets/soundfonts/38_Song_of_Healing.o"
...
beginseg
    ...
    include "build/assets/sequences/110_Final_Hours.o"
    include "build/assets/sequences/111_Ocarina_Song_of_Healing.o"
endseg
...
beginseg
    ...
    include_data_with_rodata "build/assets/misc/sounds/sounds.o"
...
beginseg
    name "object_link_deity"
    romalign 0x1000
    include "build/assets/objects/object_link_deity/object_link_deity.o"
    number 6
endseg

beginseg
    name "object_mask_deity"
    romalign 0x1000
    include "build/assets/objects/object_mask_deity/object_mask_deity.o"
    number 10
endseg
